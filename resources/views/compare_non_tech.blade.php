...
<body>
    ...
    <div class="report-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- Bar Chart: مقایسه بودجه و هزینه واقعی فناوری  -->
                <div class="chart-container">
                    <h4>مقایسه بودجه و هزینه واقعی فناوری </h4>
                    <canvas id="budgetCostBarChart"></canvas>
                </div>
                <hr class="chart-divider">

                <!-- Bar Chart: مقایسه تعداد پرسنل فناوری  -->
                <div class="chart-container">
                    <h4>مقایسه تعداد پرسنل فناوری </h4>
                    <canvas id="itStaffBarChart"></canvas>
                </div>
                <hr class="chart-divider">

                
                <!-- Bar Chart: فراوانی پرسنل فناوری بر اساس تخصص در کل شرکت‌ها -->
                <div class="chart-container">
                    <h4>فراوانی پرسنل فناوری بر اساس تخصص در کل شرکت‌ها</h4>
                    <canvas id="allSpecialtiesBarChart"></canvas>
                </div>
                <hr class="chart-divider">

                <!-- Bar Chart: فراوانی پرسنل فناوری بر اساس تحصیلات در کل شرکت‌ها -->
                <div class="chart-container">
                    <h4>فراوانی پرسنل فناوری بر اساس تحصیلات در کل شرکت‌ها</h4>
...
<hr class="chart-divider">
<!-- Bar Chart: تناسب تعداد پرسنل فناوری با کاربران فعال -->
                <div class="chart-container">
                    <h4>تناسب تعداد پرسنل فناوری با کاربران فعال</h4>
